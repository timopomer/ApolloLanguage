...
namespace ApolloLanguageCompiler.Tests
{
    ...
    public class TestExpressionParser
    {
        ...
        [Test()] public void CallFunctionWithParanethesisInParametersTest() => TestExpression(@"func((1),(1+2))", "Unary<FunctionCall>[Many[Token[LiteralNumber->1],Binary<Addition>[Token[LiteralNumber->1], Token[Plus->+], Token[LiteralNumber->2]]], Token[Identifier->func]]");
        ...
        [Test()] public void CallFunctionWithMultipleParametersTest() => TestExpression(@"func(1,2)", "Unary<FunctionCall>[Many[Token[LiteralNumber->1],Token[LiteralNumber->2]], Token[Identifier->func]]");
        ...
        [Test()] public void EqualityInEqualityTest() => TestExpression(@"(false==true)!=false", "Binary<Equality>[Binary<Equality>[Token[LiteralFalse->false], Token[Equal->==], Token[LiteralTrue->true]], Token[InEqual->!=], Token[LiteralFalse->false]]");
        ...
        [Test()] public void SimpleParanthesizedNumberTest() => TestExpression(@"(3)", "Token[LiteralNumber->3]");
    }
}
